...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`MM2 VALUE`}</title>

        <meta
          name="description"
          content="Experience the future of transportation with MM2 VALUE - your gateway to convenient, efficient car sharing. Find, book, and track your ride in real-time, all from our user-friendly interface."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605618312848-1c2f4e6fd755?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjBzaGFyaW5nfGVufDB8fHx8MTY5MDA5MzAyMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of transportation with MM2 VALUE - your gateway to convenient, efficient car sharing. Find, book, and track your ride in real-time, all from our user-friendly interface.`}
            </Text>
            <Box
